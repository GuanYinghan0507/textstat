...
@pytest.mark.parametrize(
    ...
    [
        ...
        (resources.EASY_HUNGARIAN_TEXT, "hu_HU", 0.0),
...
def test_smog_index_rejects_whitespace_and_short_samples() -> None:
    assert metrics.smog_index("   \n\t  ", "en_US") == 0.0
    assert metrics.smog_index("Extraordinary circumstances complicate communication.", "en_US") == 0.0
